...
/**
 * <p>The <code>Ad</code> class creates an Ad object with id, userId, title, and description properties.
 * This object can be used to store and retrieve information about ads for use with an adlister applicaton.</p>
 *
